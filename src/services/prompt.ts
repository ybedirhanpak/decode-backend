...
I will provide you design data examples with this format.

Your job is to generate react code and module css codes.

Rules for react code:
- Use semantic HTML elements.
- If this is a Button component, use a <button> element. If this is a input component, use <input> etc.
